...
enum_with_from_u8! {
    ...
    pub enum Instruction {
        ...
        STATICCALL = 0xfa,
        #[doc = "dedicated INVALID instruction"]
        INVALID = 0xfe,
...
impl Instruction {
    ...
    pub fn pushes_constant(&self) -> bool {
        self.is_push() || *self == PC
    }
...
lazy_static! {
    ...
    static ref INSTRUCTIONS: [Option<InstructionInfo>; 0x100] = {
        ...
        arr[INVALID as usize] = Some(InstructionInfo::new("INVALID", 0, 0, GasPriceTier::Special));
